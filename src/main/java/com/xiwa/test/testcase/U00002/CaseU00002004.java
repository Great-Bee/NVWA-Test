 ...
 */
public class CaseU00002004 extends BaseTestCase {
...
//    private static final Logger logger = Logger.getLogger(CaseU00002001.class);
    ...
    @Test
    public void testCaseU00002004(){
        logger.info("----------------------test start-------------------------");

        String url = ResponseConstant.HOST + URL_Layout+"/null";
        ...
        if (nvwaResponse != null) {
            ...
            //返回的response为空
            //test false
            logger.info("[testCaseU00002004][testCaseU00002004]: response is null");
        }

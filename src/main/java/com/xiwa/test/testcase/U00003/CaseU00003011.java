 ...
 */
public class CaseU00003011 extends BaseTestCase {
...
//    private static final Logger logger = Logger.getLogger(CaseU00002001.class);
    ...
    private void mainTest(){
        //读取这个JS File 是否存在
        String url = ResponseConstant.HOST + URL_User_Read+"/api/"+ UUID.randomUUID().toString() +"/"+dataIdListA.get(0);//dataIdListA.get(0)
        ...
        if (nvwaResponse != null) {
            ...
            //返回的response为空
            //test false
            logger.info("[testCaseU00003011][testCaseU00003011]: response is null");
        }
    }

 ...
 */
public class CaseU00003005 extends BaseTestCase {
    ...
    private void mainTest(){
        //读取这个JS File 是否存在
        String url = ResponseConstant.HOST + URL_User_Read+"/"+formPage.getAlias()+"/"+ UUID.randomUUID().toString()+"/"+dataIdListA.get(0);
        ...
        if (nvwaResponse != null) {
            ...
            //返回的response为空
            //test false
            logger.info("[testCaseU00003005][testCaseU00003005]: response is null");
        }
    }

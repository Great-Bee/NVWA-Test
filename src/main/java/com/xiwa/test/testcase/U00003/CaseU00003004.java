 ...
 */
public class CaseU00003004 extends BaseTestCase {
...
//    private static final Logger logger = Logger.getLogger(CaseU00002001.class);
    ...
    private void mainTest(){
        //读取这个JS File 是否存在
        String url = ResponseConstant.HOST + URL_User_Read+"/"+ UUID.randomUUID().toString()+"/"+formContainer.getAlias()+"/"+dataIdListA.get(0);
        ...
        if (nvwaResponse != null) {
            ...
            //返回的response为空
            //test false
            logger.info("[testCaseU00003004][testCaseU00003004]: response is null");
        }
    }
